 ...
 */
package com.apress.azm.UserRegistrationSystem.filter;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter
{
    ...
    {
        if (hsr.getServletPath ().equals ("/api/login") || hsr.getServletPath ().equals ("/api/token/refresh"))
        {
        ...
        else
        {
            ...
            if (authorizationHeader != null && authorizationHeader.startsWith ("Bearer "))
            {
                ...
                catch (Exception e)
                {
                    ...
                    hsr1.setHeader ("Error", e.getMessage ());
                    ...
                    new ObjectMapper ().writeValue (hsr1.getOutputStream (), error);
                }
            }
            else
            {
